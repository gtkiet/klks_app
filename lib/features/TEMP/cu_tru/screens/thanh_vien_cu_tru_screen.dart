      ...
      child: Column(
        ...
        children: [
          ...
          if (d.taiLieuCuTrus.isNotEmpty) ...[
            ...
            ...d.taiLieuCuTrus.map((doc) {
              // Tập hợp tất cả file trong doc để gallery swipe hoạt động
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (doc.soGiayTo.isNotEmpty) Text('Số: ${doc.soGiayTo}'),
                      ...
                      if (doc.files.isNotEmpty) ...[
                        ...
                        // Thumbnail grid cho ảnh
                        if (allFiles.any((f) => f.isImage))
                          FileGrid(
                            files: allFiles.where((f) => f.isImage).toList(),
                          ),
                        // List tile cho file không phải ảnh
                        ...allFiles
                            .where((f) => !f.isImage)
                            .map(
                              (f) => FileListTile(file: f, siblings: allFiles),
                            ),
                      ],
                    ],
                  ),
