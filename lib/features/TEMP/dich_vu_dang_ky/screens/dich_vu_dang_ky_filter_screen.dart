// // lib/features/dich_vu_dang_ky/screens/dich_vu_dang_ky_filter_screen.dart
...
// class DichVuDangKyFilterScreen extends StatefulWidget {
//   const DichVuDangKyFilterScreen({
//     super.key,
//     required this.currentRequest,
//     required this.loaiDichVuList, // truyền từ List screen, đã load sẵn
//   });
...
//   @override
//   State<DichVuDangKyFilterScreen> createState() =>
//       _DichVuDangKyFilterScreenState();
// }

// class _DichVuDangKyFilterScreenState extends State<DichVuDangKyFilterScreen> {
...
//   // _TODO: load trangThaiDangKy từ catalog API khi có endpoint
//   // Hiện tại dùng giá trị tạm — thay bằng SelectorItem khi catalog sẵn sàng
//   static const _trangThaiOptions = [
//     _OptionData(id: null, label: 'Tất cả trạng thái'),
//     _OptionData(id: 1, label: 'Đang hoạt động'),
//     _OptionData(id: 2, label: 'Hết hạn'),
//     _OptionData(id: 3, label: 'Đã hủy'),
//   ];
...
//   void _apply() {
//     // _TODO: validate _tuNgay < _denNgay
...
//           // ── Loại dịch vụ — dùng catalog thực ───────────────────────────
...
// class _OptionData {
//   const _OptionData({required this.id, required this.label});
//   final int? id;
//   final String label;
// }