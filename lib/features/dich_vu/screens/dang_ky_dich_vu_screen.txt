...
class _DangKyDichVuScreenState extends State<DangKyDichVuScreen> {
  ...
  Widget _buildCanHoSelector() {
    ...
    //   //         value: canHo,
    //   //         child: Text(canHo.diaChiDayDu, overflow: TextOverflow.ellipsis),
    //   //       ),
    //   //     )
    //   //     .toList(),
    //   // SAU
    ...
    //       )
    //       .toList(),
    //   isExpanded: true, // ← THÊM DÒNG NÀY vào DropdownButtonFormField
  ...
  Widget _buildSubmitButton() {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        // Disable nếu đang submit, đang load căn hộ, hoặc list rỗng
