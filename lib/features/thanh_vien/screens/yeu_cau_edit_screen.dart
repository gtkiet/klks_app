...
class _YeuCauEditScreenState extends State<YeuCauEditScreen> {
  ...
  late final Future<List<SelectorItemModel>> _gioiTinhFuture = _utilsSvc
      .getGioiTinhSelector();
  late final Future<List<SelectorItemModel>> _loaiQuanHeFuture = _utilsSvc
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Chỉnh sửa yêu cầu #${widget.yeuCauId}')),
      body: _buildBody(),
    );
  }
        ...
        : Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                Field(controller: _noiDungCtrl, label: 'Ghi chú', maxLines: 3),
                const SizedBox(height: 20),
